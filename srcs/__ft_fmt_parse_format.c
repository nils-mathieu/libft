...
/*   Updated: 2022/05/16 18:16:24 by nmathieu         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static inline t_fmt_handler	*fmt_handler(void)
{
	static t_fmt_handler	handlers[FORMAT_HANDLER_COUNT] = {
		...
		(t_fmt_handler){(t_str){"i", 3}, __ft_fmt_handle_int},
		(t_fmt_handler){(t_str){"s?", 3}, __ft_fmt_handle_debug_string},
		(t_fmt_handler){(t_str){"s", 3}, __ft_fmt_handle_string},
